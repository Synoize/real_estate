                ...
                <?php foreach ($projects as $project): ?>
                    ...
                    <article class="h-full">
                        <div class="relative h-full bg-white rounded-2xl border border-gray-200 p-2 md:p-3 transition duration-300 hover:-translate-y-1 hover:shadow-sm">
                            <a href="<?php echo BASE_URL . 'project/' . urlencode($project['slug']); ?>" class="relative block overflow-hidden rounded-lg md:rounded-2xl" data-project-gallery>
                            ...
                            <div class="pt-4 p-1">
                                ...
                                <div class="grid grid-cols-2 gap-2 md:gap-3 mt-4 text-[10px] md:text-xs">
                                    ...
                                    <a href="https://wa.me/<?php echo preg_replace('/\D+/', '', $project['whatsapp_number'] ?: $project['builder_phone']); ?>?text=<?php echo urlencode('I am interested in ' . $project['project_name']); ?>" class="flex items-center justify-center gap-2 bg-green-600 text-white py-2 md:py-3 rounded-lg hover:opacity-90 duration-300">
